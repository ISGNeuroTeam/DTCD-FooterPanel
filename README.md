...
```
tar -zxf DTCD-FooterPanel-*.tar.gz ./DTCD-FooterPanel
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/ISGNeuroTeam/DTCD-FooterPanel/tags).
